...
Reconst::Reconst(Mat& map_x, Mat& map_y, Mat& right_image, Mat& left_image, stereoParams& stereo_params)
{
...
void Reconst::getCorrelationIntensities(Mat& dst)
{
    dst = corr_intensities_;
}

void Reconst::getCorrelation_X_Derivative(Mat& dst)
{
    dst = corr_x_derivative_;
}

void Reconst::getCorrelation_Y_Derivative(Mat& dst)
{
    dst = corr_y_derivative_;
}

void Reconst::getStdMap(Mat& dst)
{
    dst = std_map_;
}

void Reconst::getCostMap(Mat& dst)
{
    dst = cost_map_;
}
